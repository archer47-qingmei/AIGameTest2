...
enum EffectType {
	...
	MAX_DECK_SIZE,
	GOLD_ON_EVENT,
	BLOCK_ON_ATTACK_PLAYED,
	FIRST_ATTACK_BONUS,
	GOLD_IF_NO_DAMAGE,
	GOLD_ON_BLOCK,
	EXTRA_REWARD_CARD,
	SHOP_DISCOUNT,
	SHOP_SECOND_HALF_PRICE,
	EXTRA_SHOP_RELIC,
	BLOCK_ON_TURN_END_NO_ATTACK,
	STRENGTH_ON_FINISHER,
	ENERGY_PER_N_CARDS,
	REDUCE_FIRST_N_DAMAGE,
	HEAL_HP_PERCENT_ONCE_LOW,
	SUPPRESS_CURSE_DAMAGE,
	EXTRA_EVENT_CHOICE,
	SHOW_ENEMY_MAX_HP,
}
